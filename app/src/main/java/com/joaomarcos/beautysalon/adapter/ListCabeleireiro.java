...
public class ListCabeleireiro extends  RecyclerView.Adapter<ListCabeleireiro.MyViewHolder>{
    Context context;
    ArrayList<Empresas> empresasArrayList;
    Empresas empresas;

    public ListCabeleireiro(Context context, ArrayList<Empresas> empresasArrayList) {
        this.context = context;
        this.empresasArrayList = empresasArrayList;
    }
    @NonNull
    @Override
    public ListCabeleireiro.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_list_favoritos, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ListCabeleireiro.MyViewHolder holder, int position) {
