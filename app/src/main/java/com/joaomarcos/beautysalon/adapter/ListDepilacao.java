...
public class ListDepilacao extends RecyclerView.Adapter<ListDepilacao.MyViewHolder> {
    Context context;
    ArrayList<Empresas> empresasArrayList;
    Empresas empresas;

    public ListDepilacao(Context context, ArrayList<Empresas> empresasArrayList) {
    ...
    @NonNull
    @Override
    public ListDepilacao.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_list_favoritos, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ListDepilacao.MyViewHolder holder, int position) {
