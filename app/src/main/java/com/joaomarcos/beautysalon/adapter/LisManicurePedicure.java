...
public class LisManicurePedicure extends RecyclerView.Adapter<LisManicurePedicure.MyViewHolder> {
    Context context;
    ArrayList<Empresas> empresasArrayList;
    Empresas empresas;

    public LisManicurePedicure(Context context, ArrayList<Empresas> empresasArrayList) {
    ...
    @NonNull
    @Override
    public LisManicurePedicure.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_list_favoritos, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull LisManicurePedicure.MyViewHolder holder, int position) {
