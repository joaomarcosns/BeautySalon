...
public class ListLimpezaPele extends RecyclerView.Adapter<ListLimpezaPele.MyViewHolder> {
    Context context;
    ArrayList<Empresas> empresasArrayList;
    Empresas empresas;

    public ListLimpezaPele(Context context, ArrayList<Empresas> empresasArrayList) {
    ...
    @NonNull
    @Override
    public ListLimpezaPele.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_list_favoritos, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ListLimpezaPele.MyViewHolder holder, int position) {
